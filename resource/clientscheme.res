...
"Scheme"
{
	...
	{
		// BUFF
		"gradient"												"165 168 233 255"
		"gradient1"                                           "157 162 236 255"
		"gradient2"                                           "148 156 238 255"
		"gradient3"                                           "139 150 241 255"
		"gradient4"                                           "128 145 244 255"
		"gradient5"                                           "117 139 247 255"
		"gradient6"                                           "104 134 250 255"
		"gradient7"                                           "89 128 252 255"
		"gradient8"                                           "71 123 255 255"

		//PULSE
		"gradientBUFF" 									   "239 238 252 255"
		"gradientBUFF1"                                 "227 229 251 255"
		"gradientBUFF2"                                 "214 219 249 255"
		"gradientBUFF3"                                 "202 210 248 255"
		"gradientBUFF4"                                 "190 201 246 255"
		"gradientBUFF5"                                "177 191 245 255"
		"gradientBUFF6"                                 "165 182 243 255"
		"gradientBUFF7"                                 "152 172 242 255"
		"gradientBUFF8"                                 "140 163 240 255"

		// LOW
		"gradientLOW"												"233 168 165 255"
		"gradient1LOW"                                           "236 162 157 255"
		"gradient2LOW"                                           "238 156 148 255"
		"gradient3LOW"                                           "241 150 139 255"
		"gradient4LOW"                                           "244 145 128 255"
		"gradient5LOW"                                           "247 139 117 255"
		"gradient6LOW"                                           "250 134 104 255"
		"gradient7LOW"                                           "252 128 89 255"
		"gradient8LOW"                                           "255 123 71 255"

		// PULSE
		"gradientLOW1"                                 "252 238 239 255"
		"gradientLOW2"                                 "251 229 227 255"
		"gradientLOW3"                                 "249 219 214 255"
		"gradientLOW4"                                 "248 210 202 255"
		"gradientLOW5"                                "246 201 190 255"
		"gradientLOW6"                                 "245 191 177 255"
		"gradientLOW7"                                 "243 182 165 255"
		"gradientLOW8"                                 "242 172 152 255"
		"gradientLOW9"                                 "240 163 140 255"


		"accentM1"											"255 180 80 255"
		"accentN1"											"255 30 30 255"
	...
	"BaseSettings"
	{
		...
		"Button.BgColor"									"Gray30"
		"Button.ArmedTextColor"								"White"
		"Button.ArmedBgColor"								"Gray30"
		"Button.SelectedTextColor"							"Main"
		"Button.SelectedBgColor"							"Gray30"
		"Button.DepressedTextColor"							"Main"
		"Button.DepressedBgColor"							"Gray30"
	...
	"Borders"
	{
		...
		{
			"image" "White" "color" "Gray30" "bordertype" "scalable_image"
		}
